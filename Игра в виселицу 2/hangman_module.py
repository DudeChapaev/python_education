...
def is_win():
    """Проверяет победу."""
    return GAME_STATE["win"] and GAME_STATE["game_over"]


def is_lose():
    """Проверяет поражение."""
    return not GAME_STATE["win"] and GAME_STATE["game_over"]
...
def show_lose_message():
    """Показывает сообщение о поражении."""
    show_screen()
    print("ВЫ ПРОИГРАЛИ!")
